...
MyWidget::MyWidget()
{
    ...
    connect(shapeComboBox, &QComboBox::activated, this, &MyWidget::shapeChanged);
    connect(penWidthSpinBox, &QSpinBox::valueChanged, this, &MyWidget::penChanged);
    connect(penStyleComboBox, &QComboBox::activated, this, &MyWidget::penChanged);
    connect(penCapComboBox, &QComboBox::activated, this, &MyWidget::penChanged);
    connect(penJoinComboBox, &QComboBox::activated, this, &MyWidget::penChanged);
    connect(brushStyleComboBox, &QComboBox::activated, this, &MyWidget::brushChanged);
    connect(antialiasingCheckBox, &QAbstractButton::toggled, renderArea, &RenderArea::setAntialiased);
    connect(transformationsCheckBox, &QAbstractButton::toggled, renderArea, &RenderArea::setTransformed);
...
void MyWidget::brushChanged()
{
    ...
    if (style == Qt::LinearGradientPattern) {
        ...
        renderArea->setBrush(QBrush(QPixmap(":/images/Linux_old.png").scaled(40, 40, Qt::KeepAspectRatio)));
    } else {
